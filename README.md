# Mixed Models - West, Finch & Galecki

Sitio web con ejemplos trabajados de modelos mixtos en R, basados en tres libros de texto de referencia.

## 📚 Libros

| Libro | Autores |
|-------|---------|
| *Linear Mixed Models: A Practical Guide Using Statistical Software* | West, Brady T., Welch, Kathleen B., Galecki, Andrzej T. |
| *Multilevel Modeling Using R* | Finch, W. Holmes, Bolin, Jocelyn E., Kelley, Ken |
| *Linear Mixed-Effects Models Using R* | Galecki, Andrzej T., Burzykowski, Tomasz |

## 📊 Ejemplos

| Ejemplo | Libro | Capítulo | Modelo |
|---------|-------|----------|--------|
| 🎯 Two-Level Clusters (Rat Pup) | West et al. | Cap. 3 (p.59) | Modelos para datos en clusters de 2 niveles |
| Three-Level Clusters (Classroom) | West et al. | Cap. 4 (p.135) | Modelos para datos en clusters de 3 niveles |
